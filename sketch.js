...
function setup() {
  ...
  //give the save button value in a variable and use that variable to sva ethe drawing in database when mouse is pressed throuygh a function
...
//create a function to save the drawing in the database
